...
<a href="{{ route('transaksi.create') }}" class="btn btn-primary mb-3" style="background-color: #1324b8; color: white;">Tambah Transaksi</a>
...
<table class="table table-bordered table-stripped">
    <thead>
        <tr style="background-color: #1d10cf; color: white;">
            <th>No</th>
            <th>Kode Invoice</th>
            <th>Pelanggan</th>
            <th>Outlet</th>
