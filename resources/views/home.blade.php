...
@section('main-content')
    ...
    <div class="row">
        <div class="col-md-3 col-12">
            <a href="{{ url('/home/generate-data') }}" class="btn btn-primary mb-2" style="background-color: #0a18d1; color: white;">Cetak Data</a>
        </div>
        <div class="col-12">
            <table class="table table-bordered table-stripped">
                <thead>
                    <tr style="background-color: #0f12d6; color: white;">
                        <th>No</th>
                        <th>Kode Invoice</th>
                        <th>Pelanggan</th>
                        <th>Outlet</th>
